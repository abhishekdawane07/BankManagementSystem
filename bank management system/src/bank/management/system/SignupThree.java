...
public class SignupThree  extends JFrame implements ActionListener{
    ...
    SignupThree (String formno){
        ...
        JLabel carddetails=new JLabel("Your 15 Digit Card Number");
        ...
        c7= new JCheckBox("I hereby declres that the above entered details to the best of my knoweldge");
